...
async def stage2_agent_routing():
    ...
    # Repo root = two parents up from brier_agent/tests/phase4a_smoketest.py.
    # Ensure the launched server subprocess can import brier_agent even if
    # PYTHONPATH was not set in the shell.
    ...
    mcp = MCPClient(server_path=str(fake_server), env=child_env)
