...
def deployment_prompt() -> str:
    ...
    The base prompt plus the report step. The benchmark deliberately does NOT use
    this: it narrows the tool surface for context, and produces the report itself.
    """
    return SYSTEM_PROMPT + REPORT_ADDENDUM
